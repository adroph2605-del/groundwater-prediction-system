  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors">
      ...
      <header className="sticky top-0 z-50 bg-white/90 dark:bg-slate-950/90 backdrop-blur border-b border-slate-200 dark:border-slate-800">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-sm sm:hidden">GPS</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={toggle}
              className="text-xs px-2.5 py-1.5 rounded-full border border-slate-200 dark:border-slate-700"
            >
              {dark ? "Light" : "Dark"}
            </button>
            <button
              onClick={() => i18n.changeLanguage("en")}
              className={`text-xs px-2 py-1 rounded-full border hidden sm:inline-flex ${
                i18n.language === "en"
            ...
            <Link
              to="/app"
              className="hidden sm:inline-flex text-sm px-4 py-2 rounded-lg bg-[#135AAD] text-white font-medium hover:bg-[#0f4a8f]"
            >
              Launch App
            </Link>
            ...
            <button
              ...
              className="md:hidden p-2 rounded-lg border border-slate-200 dark:border-slate-700 text-lg"
            >
              {menuOpen ? "×" : "☰"}
            </button>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 px-4 py-4 space-y-3">
            <a href="#features" onClick={() => setMenuOpen(false)} className="block text-sm py-2">Features</a>
            <a href="#how" onClick={() => setMenuOpen(false)} className="block text-sm py-2">How It Works</a>
            <a href="#coverage" onClick={() => setMenuOpen(false)} className="block text-sm py-2">Coverage</a>
            <div className="flex gap-2 pt-2">
              <button onClick={() => i18n.changeLanguage("en")} className="text-xs px-3 py-1.5 rounded-full border">EN</button>
              <button onClick={() => i18n.changeLanguage("sw")} className="text-xs px-3 py-1.5 rounded-full border">SW</button>
            </div>
            <Link
              to="/app"
              onClick={() => setMenuOpen(false)}
              className="block text-center text-sm px-4 py-2.5 rounded-lg bg-[#135AAD] text-white font-medium"
            >
              Launch App
            </Link>
          </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#135AAD] via-[#1a6bc4] to-[#0d4a8c] text-white">
        <div className="max-w-6xl mx-auto px-4 py-12 md:py-20 lg:py-24 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
          {/* Left text */}
          <div className="text-center md:text-left">
            ...
            <p className="mt-4 text-blue-100 text-sm sm:text-base max-w-md mx-auto md:mx-0">
            ...
            <div className="mt-8 flex gap-6 sm:gap-8 text-sm justify-center md:justify-start">
              <div>
              ...
              <div>
                <p className="text-xl sm:text-2xl font-bold">26</p>
          ...
          {/* Right card */}
          <div className="bg-white text-slate-800 rounded-2xl shadow-2xl p-4 sm:p-5 max-w-sm mx-auto w-full">
      ...
      <section id="features" className="py-12 md:py-20 bg-slate-50 dark:bg-slate-900">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <h2 className="mt-3 text-2xl sm:text-3xl font-bold">Everything a driller needs.</h2>
          ...
          <div className="mt-8 md:mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 md:gap-6 text-left">
            <div className="rounded-2xl p-5 md:p-6 bg-blue-50 dark:bg-blue-900/20 border border-slate-100 dark:border-slate-800">
            ...
            <div className="rounded-2xl p-5 md:p-6 bg-pink-50 dark:bg-pink-900/20 border border-slate-100 dark:border-slate-800">
            ...
            <div className="rounded-2xl p-5 md:p-6 bg-orange-50 dark:bg-orange-900/20 border border-slate-100 dark:border-slate-800 sm:col-span-2 md:col-span-1">
      ...
      <section id="how" className="py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="mt-8 md:mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 text-left">
            {[
      ...
      {/* ========== COVERAGE ========== */}
      <section id="coverage" className="py-12 md:py-20 bg-slate-50 dark:bg-slate-900">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <span className="text-xs font-semibold uppercase tracking-wider text-[#135AAD] bg-blue-50 dark:bg-blue-900/30 px-3 py-1 rounded-full">
            Coverage
          </span>
          <h2 className="mt-3 text-2xl sm:text-3xl font-bold">All 26 regions. One platform.</h2>
          <div className="mt-8 md:mt-10 grid grid-cols-2 sm:grid-cols-3 gap-3 md:gap-4">
            {[
              ...
              <div key={s.l} className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-4">
                <p className="text-xl sm:text-2xl font-bold text-[#135AAD]">{s.v}</p>
      ...
      {/* ========== CTA ========== */}
      <section className="py-12 md:py-16 bg-[#135AAD] text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold">Ready to find water?</h2>
          ...
          <div className="mt-6">
            <Link
              to="/app/predict"
              className="inline-block px-6 py-2.5 rounded-lg bg-[#E2397C] hover:bg-[#c92e6a] font-medium text-sm"
            >
              Start Free Prediction
            </Link>
          </div>
      ...
      {/* ========== FOOTER ========== */}
      <footer className="bg-slate-950 text-slate-400 py-8 md:py-10">
